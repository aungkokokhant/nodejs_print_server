...
// Use your detected Vendor ID and Product ID
const device = new USB(1155, 22304); // Replace with your `idVendor` and `idProduct`
  ...
  try {
    ...
    device.open((err) => {
      ...
      if (isTest) {
        ...
        return res.json({ message: "Test print job sent" });
      }
